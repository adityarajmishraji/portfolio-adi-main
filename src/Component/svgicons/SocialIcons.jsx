...
export const CloseIcon = memo(() => (
  <svg
    ...
    fill="none"
    stroke="#fff"
    className="feather feather-x hover:shadow-glow hover:rotate-12"
  >
...
export const MainLogo = memo(() => (
  <svg
    ...
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="absolute top-10 left-[26%] md:left-[36.3%] -translate-x-1/4 -translate-y-1/3 md:w-[580px] w-[300px] sm:w-[400px] h-auto"
  >
    <path
